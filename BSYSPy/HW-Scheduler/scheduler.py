...
print
'ARG policy', options.policy
if options.jlist == '':
    print
    'ARG jobs', options.jobs
    print
    'ARG maxlen', options.maxlen
    print
    'ARG seed', options.seed
else:
    print
    'ARG jlist', options.jlist
...
if options.solve == True:
    ...
    if options.policy == 'FIFO':
        ...
        for job in joblist:
            print
            '  [ time %3d ] Run job %d for %.2f secs ( DONE at %.2f )' % (thetime, job[0], job[1], thetime + job[1])
            thetime += job[1]
        ...
        for tmp in joblist:
            ...
            wait = t
            print
            '  Job %3d -- Response: %3.2f  Turnaround %3.2f  Wait %3.2f' % (jobnum, response, turnaround, wait)
    ...
    if options.policy == 'RR':
        ...
        while jobcount > 0:
            ...
            if runtime > quantum:
                ...
                ranfor = quantum
                print
                '  [ time %3d ] Run job %3d for %.2f secs' % (thetime, jobnum, ranfor)
    ...
    if options.policy != 'FIFO' and options.policy != 'SJF' and options.policy != 'RR':
        print
        'Error: Policy', options.policy, 'is not available.'
        sys.exit(0)
else:
    print
